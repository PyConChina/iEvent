...
class User(Model):
    username = Field(str, verbose_name=_('Username'), max_length=30, nullable=False)
    ...
    login_type = Field(CHAR, verbose_name='登录方式', choices=get_var('PARA/LOGIN_TYPE'), default='0')
    login_site = Field(str, verbose_name='认证站点')
    ...
    @classmethod
    def OnInit(cls):
        Index('user_indx', cls.c.username, cls.c.login_type, cls.c.login_site, unique=True)